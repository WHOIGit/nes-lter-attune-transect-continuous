...
make_eml(here(),
         ...
         other.entity = c("Settings_configuration_history.csv",
                          ...
                          "nes_lter_attune_fcs_20191005_AR39.tar.bz2",
